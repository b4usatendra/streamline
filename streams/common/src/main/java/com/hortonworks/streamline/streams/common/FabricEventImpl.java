 ...
 */
@JsonSerialize(as = FabricEventImpl.class)
public final class FabricEventImpl extends ForwardingMap<String, Object> implements
    StreamlineEvent {
    ...
    public static final StreamlineEvent GROUP_BY_TRIGGER_EVENT = FabricEventImpl.builder().build();
     ...
     */
    private FabricEventImpl(String id, Map<String, Object> keyValues, String dataSourceId,
        Map<String, Object> header,
        String sourceStream, Map<String, Object> auxiliaryFieldsAndValues) {
        if (keyValues instanceof FabricEventImpl) {
            this.delegate = Collections.unmodifiableMap(((FabricEventImpl) keyValues).delegate());
        } else {
            this.delegate = Collections.unmodifiableMap(keyValues);
        }
        this.id = id;
        this.dataSourceId = dataSourceId;
        this.sourceStream = sourceStream;

        this.header = header != null ? Collections.unmodifiableMap(header)
            : Collections.emptyMap();
        this.auxiliaryFieldsAndValues =
            auxiliaryFieldsAndValues != null ? Collections.unmodifiableMap(auxiliaryFieldsAndValues)
                : Collections.emptyMap();
    }
    ...
    public static class Builder {
        ...
        public FabricEventImpl build() {
            Map<String, Object> fieldsAndValues;
            if (kv != null) {
                fieldsAndValues = Collections.unmodifiableMap(kv);
            } else {
                fieldsAndValues = Collections.emptyMap();
            }

            Map<String, Object> header =
                this.header != null ? Collections.unmodifiableMap(this.header) : ImmutableMap.of();
    ...
    public static FabricEventImpl.Builder builder() {
        return new FabricEventImpl.Builder();
    }
    ...
    public StreamlineEvent addAuxiliaryFieldAndValue(String field, Object value) {
        ...
        return FabricEventImpl.builder().from(this)
    ...
    public String getDataSourceId() {
        ...
        if (res == null) {
            ...
            if (dataSourceIds instanceof List) {
                res = Joiner.on(",")
                    .join(Collections2.filter((List) dataSourceIds, new Predicate() {
                        @Override
    ...
    /**
     * Returns a new Streamline event with the given fieldsAndValues added to the existing
     * fieldsAndValues
     *
    ...
    /**
     * Returns a new Streamline event with the given headers added to the existing headers. All the
     * other fields are copied from this event.
     *
    ...
    public boolean equals(Object o) {
        ...
        FabricEventImpl that = (FabricEventImpl) o;
    ...
    public static StreamlineEvent fromString(String s) {
        ...
        try {
            ...
            return FabricEventImpl.builder()
                ...
                .auxiliaryFieldsAndValues(
                    (Map<String, Object>) event.get("auxiliaryFieldsAndValues"))
