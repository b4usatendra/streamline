 ...
 * @author suman.bn
 */
public class BeamTopologySamplingConfigImpl implements TopologySamplingConfig {
    ...
    //TODO create Flink master uri link
    private String buildBeamRestApiRootUrl(Namespace namespace, TopologySamplingContainer topologySamplingContainer) {
