...
public class BeamKafkaSinkComponent extends AbstractBeamComponent {
    ...
    private void initializeComponent(PCollection<StreamlineEvent> pCollection) {
        ...
        String keySerializer = (String) conf
            .get(TopologyLayoutConstants.JSON_KEY_KEY_SERIALIZATION);
    ...
    private Map<String, Object> addProducerProperties() {
        ...
        String[] fieldNames = {
            "bootstrapServers", "bufferMemory", "compressionType", "retries", "batchSize",
            "clientId",
            "maxConnectionIdle",
    ...
    private String getAckMode() {
        ...
        if ("None".equals(ackMode)) {
            ...
            throw new IllegalArgumentException(
                "Ack mode for kafka sink is not supported: " + ackMode);
        }
    }
