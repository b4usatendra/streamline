...
public class StreamlineEventDeserializer implements Deserializer<StreamlineEvent> {
    ...
    public StreamlineEvent deserialize(String topic, byte[] bytes) {
        ...
        Map<String, Object> keyValues = (Map<String, Object>) avroStreamsSnapshotDeserializer.deserialize(new StreamlineEventDeserializer.ByteBufferInputStream(ByteBuffer.wrap(bytes)),
                readerSchemaVersion);
