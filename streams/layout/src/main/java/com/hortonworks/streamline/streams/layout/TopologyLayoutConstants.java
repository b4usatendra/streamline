...
public final class TopologyLayoutConstants {
    ...
    public static final String BEAM_RUNNER_SERVICE = "beamRunnerService";
    ...
    //component kafka json keys
    public final static String JSON_KEY_ZK_URL = "zkUrl";
    public final static String JSON_KEY_TOPIC = "topic";
    public final static String JSON_KEY_BOOTSTRAP_SERVER = "bootstrapServers";
    public final static String JSON_KEY_KEY_SERIALIZATION = "keySerializer";
    public final static String JSON_KEY_VALUE_SERIALIZATION = "valueSerializer";
    public final static String JSON_KEY_KEY_DESERIALIZATION = "keyDeserializer";
    public final static String JSON_KEY_VALUE_DESERIALIZATION = "valueDeserializer";
