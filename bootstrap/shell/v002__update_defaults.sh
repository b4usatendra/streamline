...
function update_bundles {
    # === Source ===
    put_topology_component_bundle /streams/componentbundles/SOURCE ${component_dir}/sources/beam-kafka-source-topology-component.json SOURCE
    # === Processor ===

    # === Sink ===
    put_topology_component_bundle /streams/componentbundles/SINK ${component_dir}/sinks/beam-kafka-sink-topology-component.json SINK
    # === Topology ===
